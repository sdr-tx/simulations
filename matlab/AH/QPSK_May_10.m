...
pwm1 = cuadrada_con_desfasaje(ncyc,1,0,duty,fpwm,fs);
pwm2 = cuadrada_con_desfasaje(ncyc,1,0.5,duty,fpwm,fs);
pwm3 = cuadrada_con_desfasaje(ncyc,1,-1,duty,fpwm,fs);
pwm4 = cuadrada_con_desfasaje(ncyc,1,-0.5,duty,fpwm,fs);
...
%% PLOT
figure(3);
subplot(131);   plot(t, i_filtered);        title("i in time");
subplot(132);   plot(t, q_filtered);        title("q in time");
subplot(133);   plot(t, i_filtered);        hold on;  
                plot(t, q_filtered);        title("i+q in time");
